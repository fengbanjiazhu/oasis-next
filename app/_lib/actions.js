...
export async function deleteReservation(id) {
  ...
  if (!guestBookingIds.includes(id)) throw new Error("You can only delete your own reservations");
...
export async function updateBooking(formData) {
  ...
  if (!guestBookingIds.includes(id)) throw new Error("You can only update your own reservations");
